...
function FAQAccordion() {
  const items = [
    { q: "Сколько стоит работа, локализация каналов от Lang2Lang?", a: "Мы не берём денег за подписку, работу, локализацию. В нашем сотрудничестве мы платим вам, а не наоборот." },
    { q: "Какое количество времени занимает локализация контанта?", a: "Мы работаем быстро! Сразу после того, как вы становитесь партнёром Lang2Lang, мы сразу начинаем создание каналов и адаптируем его под новые рынки." },
