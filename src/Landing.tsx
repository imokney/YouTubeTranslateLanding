  ...
  return (
    <div className={theme === "dark" ? "dark" : ""}>
      <div className="theme-transition min-h-screen bg-white text-gray-900 dark:bg-neutral-950 dark:text-neutral-100 relative overflow-hidden">
        ...
        {/* Services */}
        <section id="services" className="scroll-mt-24 py-20 bg-orange-50 dark:bg-orange-950" data-testid="section-services">
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="mt-10 grid md:grid-cols-4 gap-6">
              {[
                ...
                {/* Cases */}
        <section id="cases" className="scroll-mt-24 py-20 bg-orange-50 dark:bg-orange-950" data-testid="section-cases">  
          <div className="max-w-6xl mx-auto px-4">
        ...
        {/* Contact */}
        <section id="contact" className="scroll-mt-24 py-20 bg-gray-50 dark:bg-orange-950" data-testid="section-contact">
